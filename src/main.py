...
if __name__ == '__main__':
    ...
    logger = CSVLogger(save_dir='../log', name='optflow_test', version=0)
    ...
    # data = ViolenceDatasetOF('/mnt/d/serao/bus_dataset/train', num_clips=8, batch_size=5)
    ...
    # model = ViolenceDetection(save_dir='../log/optflow/version_0')
